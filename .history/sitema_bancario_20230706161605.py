...
Nesse código, a classe `Banco` representa a cona bancária com seus atributos, como saldo, número de saques realizados e histórico de transações. Ela possui os métodos `deposito`, `saque` e `extrato`, que realizam as operações conforme especificado.
